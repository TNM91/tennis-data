...
describe('Teams and Leagues public intros', () => {
  ...
  it('keeps Leagues intro dense enough for phone-first discovery', () => {
    ...
    expect(styleBlock(leaguesSource, 'mobileSummaryStatusStyle')).toContain('minHeight: 34')
    expect(leaguesSource).toContain("'Updating league results...'")
    expect(leaguesSource).not.toContain("'Refreshing leagues'")
    expect(leaguesSource).not.toContain("'Reviewing matches'")
