...
describe('Player Development public cleanup', () => {
  it('positions the public page as a phone-first Level Up product story', () => {
    ...
    expect(systemSource).toContain("import RoleActionHome from '@/app/components/role-action-home'")
    expect(systemSource).toContain('<RoleActionHome')
    expect(systemSource).toContain('roleLabel="Improve"')
    expect(systemSource).toContain('contextLabel="Player path"')
    expect(systemSource).toContain("title: 'Start today\\'s Level Up'")
    expect(systemSource).toContain("title: 'My Lab'")
    expect(systemSource).toContain("title: 'Tactic plan'")
    expect(systemSource).toContain("title: 'Player path'")
    expect(systemSource).toContain("title: 'Match prep'")
