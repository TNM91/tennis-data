...
const readSource = (path: string) => readFileSync(join(process.cwd(), path), 'utf8').replace(/\r\n/g, '\n')
const pageSource = readSource('app/player-development/page.tsx')
const systemSource = readSource('app/player-development/_components/player-development-system.tsx')
const improveHomeSource = readSource('app/player-development/_components/improve-landing-hub.tsx')
const stylesSource = readSource('app/player-development/_components/player-development.module.css')
const controlsSource = readSource('app/player-development/_components/player-development-print-controls.tsx')
const liveWorkbenchSource = readSource('app/player-development/_components/player-live-workbench.tsx')
const trainingMenusSource = readSource('lib/player-training-menus.ts')
...
describe('Player Development public cleanup', () => {
  it('positions the public page as a phone-first Level Up product story', () => {
    ...
    expect(improveHomeSource).toContain("import RoleActionHome, { type RoleHomeAction } from '@/app/components/role-action-home'")
    expect(improveHomeSource).toContain('<RoleActionHome')
    expect(improveHomeSource).toContain('roleLabel="Improve"')
    expect(improveHomeSource).toContain('contextLabel="Player path"')
    expect(improveHomeSource).toContain("title: 'Start today\\'s Level Up'")
    expect(improveHomeSource).toContain("title: 'My Lab'")
    expect(improveHomeSource).toContain("title: 'Tactic plan'")
    expect(improveHomeSource).toContain("title: 'Player path'")
    expect(improveHomeSource).toContain("title: 'Match prep'")
    expect(systemSource).toContain('All Improve tools')
    expect(systemSource).toContain('includeSupportingPaths')
    expect(improveHomeSource).toContain('const primaryAction: RoleHomeAction =')
    expect(improveHomeSource).toContain("href: '/mylab#player-workshop'")
    ...
    expect(systemSource).toContain('tacticsHref={buildPlayerDevelopmentTacticsHref(identity, getIdentityStarterLevelUpCard(identity))}')
    expect(improveHomeSource).toContain('href: tacticsHref')
    expect(systemSource).toContain('className={styles.heroTitle}')
    expect(stylesSource).toContain('.improveAllTools')
    expect(stylesSource).toContain('.improveAllToolsBody')
    expect(stylesSource).toContain('overflow-wrap: anywhere')
    expect(stylesSource).toContain('.improveAllTools:not([open]) > .improveAllToolsBody')
