...
describe('Player Development public cleanup', () => {
  it('positions the public page as a phone-first Level Up product story', () => {
    ...
    expect(systemSource).toContain('Crosscourt starter board')
  ...
  it('keeps workbook and coach planner pages practical enough to print and use', () => {
    ...
    expect(systemSource).toContain("['Build the tactic board', 'Turn the Level Up cue into a visual point plan in TIQ Tactical Studio', tacticsHref]")
