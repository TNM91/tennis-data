...
describe('Captain practice scheduler', () => {
  ...
  it('opens as a practice hub before asking the captain to create another practice', () => {
    ...
    expect(source).toContain('Share or export roster')
    expect(source).toContain('listCaptainPracticeRoster(practice.event.id)')
    expect(source).toContain("exportRoster(option.kind, 'text')")
    expect(source).toContain("exportRoster(option.kind, 'csv')")
