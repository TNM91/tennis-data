...
describe('compete leagues readiness', () => {
  it('gives Leagues visitors a clear first-action path', () => {
    ...
    expect(source).toContain('Start with the league need, then open the smallest action that keeps seasons, teams, and results organized.')
    expect(source).not.toContain('Start with the league job, then open the smallest action that keeps seasons, teams, and results organized.')
