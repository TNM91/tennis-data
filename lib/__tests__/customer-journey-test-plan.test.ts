...
describe('customer journey test plan', () => {
  ...
  it('keeps the QA index as the one-page starting point', () => {
    ...
    expect(actionListScriptSource).toContain('getFixtureAuthSmokeCommand')
    expect(actionListScriptSource).toContain('Auth smoke: ${authSmokeCommand')
    ...
    expect(gapReportScriptSource).toContain('Full-Court tool fit proof cue')
    ...
    expect(qaDataScriptSource).toContain('Full-Court tool fit proof cue')
  ...
  it('keeps every agenda entry visible in the evidence checklist command', () => {
    ...
    expect(signoffSheetScriptSource).toContain('getFixtureAuthSmokeCommand')
    expect(signoffSheetScriptSource).toContain('Auth smoke: ${authSmokeCommand')
    ...
    expect(journeySessionStatusScriptSource).toContain('getFixtureAuthSmokeCommand')
    expect(journeySessionStatusScriptSource).toContain('[...rows].reverse().find')
    expect(journeySessionStatusScriptSource).toContain('Auth smoke: ${authSmokeCommand')
