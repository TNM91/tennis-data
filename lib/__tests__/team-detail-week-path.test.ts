...
describe('team detail week path', () => {
  ...
  it('keeps long team detail tables short by default with user-opened detail', () => {
    ...
    expect(styleBlock('mobileMatchMetaGridStyle')).toContain("gridTemplateColumns: 'repeat(3, minmax(0, 1fr))'")
    expect(styleBlock('mobileMatchMetaStyle')).toContain("overflowWrap: 'anywhere'")
