...
describe('team detail week path', () => {
  ...
  it('renders a purpose-built phone roster instead of compressing nine table columns', () => {
    ...
    expect(source).toContain('{selectedRosterPlayerIds.length > 0 ? <div style={rosterCompareTray}>')
    ...
    expect(styleBlock('mobileRosterCardStyle')).toContain('padding: 12')
  ...
  it('keeps long team detail tables short by default with user-opened detail', () => {
    ...
    expect(source).toContain('const mobileRosterPreviewLimit = isMobile ? 6 : 12')
