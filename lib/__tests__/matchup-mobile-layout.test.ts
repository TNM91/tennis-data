...
describe('matchup mobile layout guards', () => {
  it('collapses dense setup and comparison rows on narrow screens', () => {
    ...
    expect(matchupSource).toContain("padding: isMobile ? '10px' : controlsCard.padding")
    ...
    expect(matchupSource).toContain("paddingBottom: isMobile ? '6px' : toolHeaderStyle.paddingBottom")
    expect(matchupSource).toContain('const dynamicToolHeaderTitleStyle: CSSProperties')
    expect(matchupSource).toContain("fontSize: isMobile ? '1.35rem' : toolHeaderTitleStyle.fontSize")
    expect(matchupSource).toContain('const dynamicSelectionProgressCard: CSSProperties')
    expect(matchupSource).toContain("padding: isMobile ? '8px 10px' : selectionProgressCard.padding")
    expect(matchupSource).toContain("borderRadius: isMobile ? '12px' : selectionProgressCard.borderRadius")
    ...
    expect(matchupSource).toContain("fontSize: isMobile ? '16px' : selectionProgressValue.fontSize")
    expect(matchupSource).toContain('const dynamicToggleGroup: CSSProperties')
    expect(matchupSource).toContain("padding: isMobile ? 4 : toggleGroup.padding")
    expect(matchupSource).toContain('const dynamicToggleButton: CSSProperties')
    expect(matchupSource).toContain("padding: isMobile ? '8px 10px' : toggleButton.padding")
