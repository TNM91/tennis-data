...
describe('My Lab onboarding flow', () => {
  it('guides first-time users through identity, goal, and first read', () => {
    ...
    expect(source).toContain('Find yourself, choose a goal, open one useful card.')
    ...
    expect(source).toContain('My Lab works best when setup feels like a tennis next step')
  })
