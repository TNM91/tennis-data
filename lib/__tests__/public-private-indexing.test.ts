...
describe('public and private indexing boundaries', () => {
  it('disallows private workspaces without blocking public sections', () => {
    ...
    expect(robotsSource).not.toContain("'/compete/'")
  ...
  it('keeps Nathan-only My Quest phone-first without exposing it publicly', () => {
    ...
    expect(myQuestClientSource).toContain('mobileOfflineConfidence')
    expect(myQuestClientSource).toContain('My Quest iPhone offline confidence')
    expect(myQuestClientSource).toContain('queued safely')
    expect(myQuestClientSource).toContain('mobileEveningCloseout')
    expect(myQuestClientSource).toContain('My Quest iPhone evening closeout')
    expect(myQuestClientSource).toContain('Evening lock')
    expect(myQuestClientSource).toContain('mobileSundayReset')
    expect(myQuestClientSource).toContain('My Quest iPhone Sunday reset')
    expect(myQuestClientSource).toContain('Sunday reset')
    expect(myQuestClientSource).toContain('triggerPocketHaptic')
    expect(myQuestClientSource).toContain('navigator.vibrate')
    expect(myQuestClientSource).toContain('startCommandLongPress')
    expect(myQuestClientSource).toContain('runPrimaryCommandAction')
    expect(myQuestClientSource).toContain('onPointerDown={startCommandLongPress}')
    expect(myQuestClientSource).toContain('My Quest iPhone pocket command bar')
    expect(myQuestClientSource).toContain('Your private daily plan.')
    expect(myQuestClientSource).toContain('id="weekly-plan"')
    expect(myQuestClientSource).toContain('className={styles.questWeeklyDrawer}')
    expect(myQuestClientSource).toContain('id="quest-history"')
    expect(myQuestClientSource).toContain("parentDrawer.open = true")
    ...
    expect(myQuestClientSource).toContain('My Quest tennis week recap')
    expect(myQuestClientSource).toContain('readLocalLevelUpWeeklySessions')
    expect(myQuestClientSource).toContain('mergeLevelUpWeeklySessions')
    ...
    expect(myQuestStylesSource).toContain('.mobileTennisWeek')
    ...
    expect(myQuestStylesSource).toContain('.mobileOfflineConfidence')
    expect(myQuestStylesSource).toContain('.mobileEveningCloseout')
    expect(myQuestStylesSource).toContain('.mobileSundayReset')
    expect(myQuestStylesSource).toContain('.mobilePocketStateLabel')
    expect(myQuestStylesSource).toContain('.mobileCommandBar')
    expect(myQuestStylesSource).toContain(".pageShell[data-phone-mode='pocket'] .mobileOfflineConfidence")
    expect(myQuestStylesSource).toContain(".mobileOfflineConfidence[data-tone='amber']")
    expect(myQuestStylesSource).toContain(".pageShell[data-phone-mode='pocket'] .mobileEveningCloseout")
    expect(myQuestStylesSource).toContain(".pageShell[data-phone-mode='pocket'] .mobileSundayReset")
    ...
    expect(myQuestStylesSource).toContain(".pageShell[data-phone-mode='pocket'] .questWeeklyDrawer")
    expect(myQuestStylesSource).toContain(".pageShell[data-phone-mode='pocket'] .mobileMissionControl")
    expect(myQuestStylesSource).toContain('bottom: calc(74px + env(safe-area-inset-bottom))')
    expect(myQuestStylesSource).toContain('bottom: calc(8px + env(safe-area-inset-bottom))')
  })
})
