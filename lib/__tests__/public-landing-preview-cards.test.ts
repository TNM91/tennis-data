...
describe('public landing preview cards', () => {
  ...
  it('keeps homepage section copy approachable instead of workspace-heavy', () => {
    ...
    expect(commandCenterSource).toContain('The homepage should show useful tennis reads before asking you to choose a tool.')
    expect(commandCenterSource).toContain('Signals before tools')
    expect(commandCenterSource).toContain('Scan the read, then open the path that matches the decision in front of you.')
    ...
    expect(commandCenterSource).toContain('Explore free context, build your player path, run a team week, or organize competition without scanning three different boards.')
