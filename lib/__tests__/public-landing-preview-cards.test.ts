...
describe('public landing preview cards', () => {
  ...
  it('keeps homepage section copy approachable instead of workspace-heavy', () => {
    ...
    expect(commandCenterSource).toContain('Improve, compete, and manage without the extra noise.')
    expect(commandCenterSource).toContain('Three lanes cover the common tennis work')
    expect(commandCenterSource).toContain('Lane ${index + 1}')
