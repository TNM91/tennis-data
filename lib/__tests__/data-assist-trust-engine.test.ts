...
describe('Data Assist trust engine', () => {
  ...
  it('shows how reviewed uploads become player ID signals', () => {
    ...
    expect(source).toContain('Scorecards and Player Rosters should strengthen the correct player profile, not create mystery records.')
  ...
  it('gives upload visitors a plain source refresh path before the file picker', () => {
    ...
    expect(source).toContain("title: 'Player roster'")
