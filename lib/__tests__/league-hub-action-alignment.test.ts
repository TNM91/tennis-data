...
describe('League hub action alignment', () => {
  it('keeps the Compete hub focused on match preparation instead of League Office operations', () => {
    ...
    expect(compete).toContain('<CompeteHome')
    expect(competeHome).toContain('<RoleActionHome')
    expect(competeHome).toContain('Prep your next matchup')
    expect(competeHome).toContain('Scout player')
    expect(competeHome).toContain('Build lineup')
    expect(competeHome).toContain('Check results')
    expect(competeHome).toContain('Read a team')
    expect(compete).toContain('Understand the flight')
    expect(competeHome).toContain('Need help with match prep?')
    expect(compete).toContain('More Compete tools')
    expect(competeHome).toContain("location: 'compete_hub'")
    expect(competeHome).toContain("eventName: 'matchup_started'")
    expect(competeHome).toContain("eventName: 'lineup_preview_clicked'")
