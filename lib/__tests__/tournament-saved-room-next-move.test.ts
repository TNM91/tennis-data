...
describe('saved tournament room next move', () => {
  it('keeps saved event cards focused on one state-aware action', () => {
    ...
    expect(source).toContain('<details className="tournamentBuilderDetailsSection" style={calendarPanelStyle}>')
    expect(source).toContain('calendarSummaryStyle')
    expect(source).not.toContain('<section style={calendarPanelStyle}>')
