...
describe('Captain onboarding surface', () => {
  ...
  it('keeps Captain onboarding compact on small mobile screens', () => {
    ...
    expect(source.indexOf('<section style={dynamicCommandCenterShell}>')).toBeLessThan(
      source.indexOf('<details style={dynamicCaptainSaveStatusShell} aria-label="Captain save status">'),
    )
    expect(source).toContain('{isMobile ? (')
    expect(source).toContain('<details style={mobileCommandCenterDetailsStyle}>')
    expect(source).toContain('More captain paths')
    expect(source).toContain('Lineup, message, and league shortcuts')
    expect(source).toContain(') : captainCommandCenter}')
    expect(styleBlock('mobileCommandCenterDetailsStyle')).toContain('minWidth: 0')
    expect(styleBlock('mobileCommandCenterDetailsStyle')).toContain("overflow: 'hidden'")
    expect(styleBlock('mobileCommandCenterSummaryStyle')).toContain('minWidth: 0')
    expect(styleBlock('mobileCommandCenterSummaryStyle')).toContain("overflowWrap: 'anywhere'")
