...
describe('public info product story copy', () => {
  ...
  it('uses public workspace names on the About explainer', () => {
    expect(aboutSource).toContain('before the next tennis job needs a home base.')
  ...
  it('uses public workspace names on the How It Works explainer', () => {
    ...
    expect(howItWorksSource).toContain('before the next tennis job needs a home base')
  ...
  it('uses public workspace names on FAQ and advertising pages', () => {
    ...
    expect(faqSource).toContain('so the tennis job, account, and data context stay together.')
    expect(faqSource).toContain('League Office gives leagues of players or teams a season home base.')
