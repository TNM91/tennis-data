...
describe('Tactical Studio player access', () => {
  ...
  it('connects Tactical Studio to a Player ID starter path before the unlock prompt', () => {
    ...
    expect(gateSource).toContain("cleanGateIntentValue(searchParams.get('cardTitle'))")
    ...
    expect(gateSource).toContain('{gateIdentityLabel}: read the Player ID cue, adjust the court, then save or copy the brief.')
