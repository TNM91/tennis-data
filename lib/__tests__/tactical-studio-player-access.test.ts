...
describe('Tactical Studio player access', () => {
  ...
  it('connects Tactical Studio to a Player ID starter path before the unlock prompt', () => {
    ...
    expect(gateSource).toContain('Crosscourt pattern board opens after Player unlock.')
    expect(gateSource).toContain('Read the Player ID cue, adjust the court, then save or copy the brief.')
