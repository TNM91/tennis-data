...
describe('Tactical Studio player access', () => {
  ...
  it('opens player-ready starter boards from Improve links', () => {
    ...
    expect(studioSource).toContain('sent {entryCardTitle} into {scenario.name}')
    ...
    expect(studioSource).toContain('Copy the player brief or save the board before sending the work back to My Lab.')
