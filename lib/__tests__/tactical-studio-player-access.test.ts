...
describe('Tactical Studio player access', () => {
  ...
  it('keeps the Tactics Player ID bridge compact for phone layouts', () => {
    ...
    expect(studioStyles).toContain('inset: auto 0 -26% 44%;')
    expect(studioStyles).toContain('inset: auto 0 -18% 24%;')
    expect(studioStyles).not.toContain('inset: auto -10% -26% 44%;')
    expect(studioStyles).toContain('grid-template-columns: minmax(0, 1fr) minmax(0, 0.55fr);')
    expect(studioStyles).not.toContain('grid-template-columns: minmax(520px, 1fr) minmax(320px, 0.55fr);')
    expect(studioStyles).toContain('.gateCopy {\n  align-self: center;\n  max-width: 820px;\n  min-width: 0;\n  overflow-wrap: anywhere;')
