...
describe('admin review UI system', () => {
  ...
  it('keeps Access Control on the shared admin review shell', () => {
    ...
    expect(accessSource).toContain("minWidth: 'min(100%, 1920px)'")
    expect(accessSource).toContain("minWidth: 'min(100%, 140px)'")
    expect(accessSource).toContain("minWidth: 'min(100%, 150px)'")
    expect(accessSource).toContain("minWidth: 'min(100%, 180px)'")
    expect(accessSource).toContain("minWidth: 'min(100%, 220px)'")
    expect(accessSource).toContain("minWidth: 'min(100%, 260px)'")
  ...
  it('keeps Manage Matches on the shared admin review shell', () => {
    ...
    expect(manageMatchesSource).toContain("minWidth: 'min(100%, 320px)'")
    expect(manageMatchesSource).toContain("minWidth: 'min(100%, 1300px)'")
    expect(manageMatchesSource).toContain("minWidth: 'min(100%, 180px)'")
  ...
  it('keeps Manage Players on the shared admin review shell', () => {
    ...
    expect(managePlayersSource).toContain("minWidth: 'min(100%, 320px)'")
    expect(managePlayersSource).toContain("minWidth: 'min(100%, 1250px)'")
    expect(managePlayersSource).toContain("minWidth: 'min(100%, 180px)'")
    expect(managePlayersSource).toContain("minWidth: 'min(100%, 150px)'")
