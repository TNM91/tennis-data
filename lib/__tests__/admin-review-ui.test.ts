...
describe('admin review UI system', () => {
  ...
  it('keeps the Admin dashboard on the shared admin review shell', () => {
    ...
    expect(adminDashboardSource).toContain("style={{ width: '100%', tableLayout: 'auto' }}")
    expect(adminDashboardSource).toContain("tableLayout: 'auto'")
    expect(adminDashboardSource).toContain("gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 260px), 1fr))'")
    expect(adminDashboardSource).toContain("flexWrap: 'wrap'")
    expect(adminDashboardSource).toContain("flex: '0 0 46px'")
    expect(adminDashboardSource).toContain("style={{ minWidth: 0, overflowWrap: 'anywhere' }}")
