...
describe('admin review UI system', () => {
  ...
  it('keeps the Admin dashboard on the shared admin review shell', () => {
    ...
    expect(adminDashboardSource).toContain('title="Admin Control Center"')
    expect(adminDashboardSource).toContain('control surface for safer tennis data operations')
