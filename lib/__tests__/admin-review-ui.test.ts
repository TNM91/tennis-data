...
describe('admin review UI system', () => {
  ...
  it('keeps the Admin dashboard on the shared admin review shell', () => {
    ...
    expect(adminDashboardSource).toContain('title="Run TenAceIQ"')
    expect(adminDashboardSource).toContain('href="/admin/access"')
    expect(adminDashboardSource).toContain('See account access at a glance, then open the work that needs you.')
    ...
    expect(adminDashboardSource).toContain('<AccountTiersPanel />')
    expect(adminDashboardSource).toContain('<summary style={moreToolsSummaryStyle}>Operating health</summary>')
    expect(adminDashboardSource).toContain('<summary style={moreToolsSummaryStyle}>Specialist tools')
  ...
  it('keeps Product Events on the shared admin review shell', () => {
    ...
    expect(productEventsSource).toContain('<AdminReviewPanel style={{ marginTop: 18 }}>')
  ...
  it('keeps Access Control on the shared admin review shell', () => {
    ...
    expect(accessSource).toContain('Give the right access, without billing surprises')
    ...
    expect(accessSource).toContain('Promotional access changes TiQ features')
    expect(accessSource).toContain('ariaLabel="Promotional access offers"')
    expect(accessSource).toContain('Gift, trial, or complimentary access')
    expect(accessSource).toContain('Choose an offer from their row')
    expect(accessSource).toContain('Permanent all access')
    expect(accessSource).toContain('One complimentary month')
    expect(accessSource).toContain('View upgrade activity')
    ...
    expect(accessSource).toContain('maxWidth: 190')
