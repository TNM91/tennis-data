...
describe('homepage portal action alignment', () => {
  it('keeps Find, Team, League, and Full-Court homepage actions aligned with the persistent portal', () => {
    ...
    expect(homepage).toContain('Captain includes Player features plus availability, practice scheduling, lineup, and team messages.')
    expect(homepage).not.toContain('team message workflows')
