...
describe('homepage portal action alignment', () => {
  it('keeps Find, Team, League, and Full-Court homepage actions aligned with the persistent portal', () => {
    ...
    expect(homepage).toContain('Open the full toolkit')
    expect(homepage).toContain('Use the complete TenAceIQ toolkit.')
    expect(homepage).toContain('Every tennis role, connected.')
    expect(homepage).toContain('one connected tennis toolkit')
