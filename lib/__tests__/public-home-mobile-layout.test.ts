...
describe('Public home mobile layout guards', () => {
  ...
  it('keeps the persistent mobile portal as a docked two-level icon palette', () => {
    ...
    expect(styleBlock(portalToolbarSource, 'mobilePortalPaletteStyle')).toContain("gridAutoColumns: 'minmax(72px, 1fr)'")
    ...
    expect(styleBlock(portalToolbarSource, 'mobilePortalPaletteStyle')).toContain("scrollbarWidth: 'none'")
