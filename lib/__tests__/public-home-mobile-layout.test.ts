...
describe('Public home mobile layout guards', () => {
  ...
  it('keeps the persistent mobile portal as a docked two-level icon palette', () => {
    ...
    expect(styleBlock(portalToolbarSource, 'mobilePortalPaletteStyle')).toContain("scrollbarWidth: 'thin'")
    expect(styleBlock(portalToolbarSource, 'mobilePortalPaletteStyle')).toContain('scrollbarColor')
    ...
    expect(globalsSource).toContain('[data-mobile-portal-palette]::-webkit-scrollbar-track')
    expect(globalsSource).toContain('[data-mobile-portal-palette]::-webkit-scrollbar-thumb')
