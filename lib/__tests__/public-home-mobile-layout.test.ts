...
describe('Public home mobile layout guards', () => {
  ...
  it('keeps the persistent mobile portal as a fixed two-level icon palette', () => {
    ...
    expect(portalToolbarSource).toContain('const mobilePortalFlowHeight = mobilePortalLane ?')
    ...
    expect(styleBlock(portalToolbarSource, 'mobilePortalPaletteStyle')).toContain("gridTemplateColumns: 'repeat(6, minmax(0, 1fr))'")
