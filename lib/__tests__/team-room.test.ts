...
describe('Team Room', () => {
  ...
  it('connects the room, invite, PWA, Captain, Team, and inbox surfaces', () => {
    ...
    const notificationWorker = readFileSync(join(process.cwd(), 'public/team-room-sw.js'), 'utf8')
    ...
    expect(notificationWorker).toContain('/brand/icons/pwa-192.png?v=20260831-final-svg-v1')
