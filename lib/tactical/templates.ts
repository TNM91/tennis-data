...
export function createTacticalTemplate(key: TacticalTemplateKey): TacticalScenario {
  ...
  if (key === 'basicDoubles') {
    return {
      ...
      tokens: [
        { id: id('token'), type: 'player', label: 'S', role: 'Server', x: 62, y: 82, team: 'green', handedness: 'righty' },
        { id: id('token'), type: 'player', label: 'N', role: 'Net', x: 41, y: 59, team: 'green', handedness: 'righty' },
        { id: id('token'), type: 'player', label: 'R', role: 'Returner', x: 36, y: 18, team: 'blue', handedness: 'righty' },
        { id: id('token'), type: 'player', label: 'P', role: 'Partner', x: 62, y: 38, team: 'blue', handedness: 'righty' },
        { id: id('token'), type: 'ball', label: '', x: 55, y: 74 },
      ],
      paths: [],
      zones: [],
      cues: [
...
export const tacticalFormationPresets: Array<{
...
}> = [
  {
    ...
    players: [
      { label: 'S', role: 'Server', x: 62, y: 82, team: 'green', handedness: 'righty' },
      { label: 'R', role: 'Returner', x: 36, y: 18, team: 'blue', handedness: 'righty' },
    ],
  },
  {
    key: 'singlesAd',
    ...
    players: [
      { label: 'S', role: 'Server', x: 38, y: 82, team: 'green', handedness: 'righty' },
      { label: 'R', role: 'Returner', x: 64, y: 18, team: 'blue', handedness: 'righty' },
    ],
  },
  {
    key: 'doublesDeuce',
    ...
    players: [
      { label: 'S', role: 'Server', x: 62, y: 82, team: 'green', handedness: 'righty' },
      { label: 'N', role: 'Net', x: 41, y: 59, team: 'green', handedness: 'righty' },
      { label: 'R', role: 'Returner', x: 36, y: 18, team: 'blue', handedness: 'righty' },
      { label: 'P', role: 'Partner', x: 62, y: 38, team: 'blue', handedness: 'righty' },
    ],
  },
  {
    key: 'doublesAd',
    ...
    players: [
      { label: 'S', role: 'Server', x: 38, y: 82, team: 'green', handedness: 'righty' },
      { label: 'N', role: 'Net', x: 59, y: 59, team: 'green', handedness: 'righty' },
      { label: 'R', role: 'Returner', x: 64, y: 18, team: 'blue', handedness: 'righty' },
      { label: 'P', role: 'Partner', x: 38, y: 38, team: 'blue', handedness: 'righty' },
    ],
  },
]
