...
const CARD_SEEDS: CardSeed[] = [
  ...
  { title: 'Return Depth Lane', category: 'partner-drill', pack: 'Serve + Return', setting: ['court'], equipment: ['partner'], tags: ['return-intent', 'return-recovery', 'decision-quality'], identitySlugs: ['smart-attacker-4-0-to-4-5', 'return-disruptor-4-0', 'all-court-adapter-4-0'] },
