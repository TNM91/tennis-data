...
const identityMap: Record<string, string[]> = {
  ...
  'serve-plus-one': ['all-court-adapter-4-0'],
  'forward-close': ['all-court-adapter-4-0'],
  'crosscourt-build': ['consistent-builder-4-0'],
  'wide-ball-reset': ['consistent-builder-4-0'],
  'defense-to-neutral': ['consistent-builder-4-0'],
  'wall-work': ['consistent-builder-4-0'],
...
const CARD_SEEDS: CardSeed[] = [
  ...
  { title: 'Wide-Ball Neutralizer', category: 'movement-engine', pack: 'Movement Engine', setting: ['court'], equipment: ['cones'], tags: ['movement', 'defense', 'wide-ball-reset', 'defense-to-neutral'], identitySlugs: ['relentless-competitor-4-0', 'consistent-builder-4-0', 'all-court-adapter-4-0'] },
  { title: 'Short-Ball Close + Split', category: 'movement-engine', pack: 'Movement Engine', setting: ['court'], equipment: ['cones'], tags: ['movement', 'attack', 'forward-close', 'decision-quality'], identitySlugs: ['smart-attacker-4-0-to-4-5', 'all-court-adapter-4-0'] },
  ...
  { title: 'Post-Play Mobility Reset', category: 'recovery-reset', pack: 'Recovery Mode', setting: ['home', 'court', 'match-day'], equipment: ['none'], tags: ['recovery', 'mobility'], identitySlugs: ['relentless-competitor-4-0', 'consistent-builder-4-0'] },
  { title: 'Wall Rally Rhythm', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'rhythm'] },
  { title: 'Wall Depth Builder', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'wall-work', 'depth', 'crosscourt-build'], identitySlugs: ['consistent-builder-4-0'] },
  { title: 'Wall Recovery Rule', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'recovery'] },
  { title: 'Wall Alternating FH/BH', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'wall-work', 'strokes', 'crosscourt-build'], identitySlugs: ['consistent-builder-4-0'] },
  ...
  { title: 'Serve +1 Shadow', category: 'serve-return', pack: 'Serve + Return', setting: ['court', 'home'], equipment: ['none'], tags: ['serve', 'attack', 'serve-plus-one', 'decision-quality'], identitySlugs: ['smart-attacker-4-0-to-4-5', 'all-court-adapter-4-0'] },
  { title: 'Return Shadow Split Read', category: 'serve-return', pack: 'Serve + Return', setting: ['home', 'court'], equipment: ['none'], tags: ['return-intent', 'split-step', 'shadow-swing', 'quick-win'] },
  { title: 'Return Depth Lane', category: 'partner-drill', pack: 'Serve + Return', setting: ['court'], equipment: ['partner'], tags: ['return-intent', 'return-recovery', 'decision-quality'], identitySlugs: ['smart-attacker-4-0-to-4-5', 'all-court-adapter-4-0'] },
  ...
  { title: 'Basket Backhand Crosscourt', category: 'solo-drill', pack: 'Solo Court Drills', setting: ['court'], equipment: ['basket'], tags: ['strokes', 'backhand', 'crosscourt-build'], identitySlugs: ['consistent-builder-4-0', 'all-court-adapter-4-0'] },
  { title: 'Pressure Basket', category: 'solo-drill', pack: 'Solo Court Drills', setting: ['court'], equipment: ['basket'], tags: ['pressure', 'basket'] },
  { title: 'Crosscourt Consistency', category: 'partner-drill', pack: 'Partner Drills', setting: ['court'], equipment: ['partner'], tags: ['partner', 'consistency', 'crosscourt-build', 'decision-quality'], identitySlugs: ['consistent-builder-4-0', 'smart-attacker-4-0-to-4-5', 'all-court-adapter-4-0'] },
  { title: 'Defense-Neutral-Attack Rally', category: 'partner-drill', pack: 'Partner Drills', setting: ['court'], equipment: ['partner'], tags: ['partner', 'attack', 'decision-quality', 'defense-to-neutral'], identitySlugs: ['all-court-adapter-4-0', 'smart-attacker-4-0-to-4-5'] },
  ...
  { title: 'Doubles Return First Move', category: 'doubles-drill', pack: 'Doubles Tools', setting: ['court'], equipment: ['partner'], tags: ['doubles-communication', 'return-intent', 'partner-first-move'], identitySlugs: ['doubles-commander-4-0'] },
  ...
  { title: 'Volley Ready Split', category: 'partner-drill', pack: 'Net + Volley Tools', setting: ['court'], equipment: ['partner'], tags: ['volley', 'split-step', 'forward-close', 'quick-win'] },
  { title: 'Volley Punch Target', category: 'partner-drill', pack: 'Net + Volley Tools', setting: ['court'], equipment: ['partner'], tags: ['volley', 'decision-quality', 'forward-close'] },
  { title: 'Approach Volley Close', category: 'partner-drill', pack: 'Net + Volley Tools', setting: ['court'], equipment: ['partner'], tags: ['volley', 'forward-close', 'attack-balance', 'decision-quality'], identitySlugs: ['all-court-adapter-4-0', 'smart-attacker-4-0-to-4-5'] },
  ...
  { title: 'Three-Step Reset', category: 'mental-routine', pack: 'Pressure + Mental Reset', setting: ['court', 'match-day'], equipment: ['none'], tags: ['pressure', 'mental-routine', 'match-day', 'pressure-reset'], identitySlugs: ['relentless-competitor-4-0', 'consistent-builder-4-0', 'all-court-adapter-4-0'] },
