...
const CARD_SEEDS: CardSeed[] = [
  ...
  { title: 'Wide-Ball Neutralizer', category: 'movement-engine', pack: 'Movement Engine', setting: ['court'], equipment: ['cones'], tags: ['movement', 'defense', 'wide-ball-reset', 'defense-to-neutral'], identitySlugs: ['relentless-competitor-4-0', 'consistent-builder-4-0'] },
  ...
  { title: 'Return Depth Lane', category: 'partner-drill', pack: 'Serve + Return', setting: ['court'], equipment: ['partner'], tags: ['return-intent', 'return-recovery', 'decision-quality'] },
  ...
  { title: 'Basket Forehand Crosscourt', category: 'solo-drill', pack: 'Solo Court Drills', setting: ['court'], equipment: ['basket'], tags: ['attack', 'forehand', 'crosscourt-build'], identitySlugs: ['smart-attacker-4-0-to-4-5', 'consistent-builder-4-0'] },
  { title: 'Basket Backhand Crosscourt', category: 'solo-drill', pack: 'Solo Court Drills', setting: ['court'], equipment: ['basket'], tags: ['strokes', 'backhand', 'crosscourt-build'], identitySlugs: ['consistent-builder-4-0'] },
  { title: 'Pressure Basket', category: 'solo-drill', pack: 'Solo Court Drills', setting: ['court'], equipment: ['basket'], tags: ['pressure', 'basket'] },
  { title: 'Crosscourt Consistency', category: 'partner-drill', pack: 'Partner Drills', setting: ['court'], equipment: ['partner'], tags: ['partner', 'consistency', 'crosscourt-build', 'decision-quality'], identitySlugs: ['consistent-builder-4-0', 'smart-attacker-4-0-to-4-5'] },
  ...
  { title: 'Approach Volley Close', category: 'partner-drill', pack: 'Net + Volley Tools', setting: ['court'], equipment: ['partner'], tags: ['volley', 'forward-close', 'attack-balance'] },
  ...
  { title: 'Three-Step Reset', category: 'mental-routine', pack: 'Pressure + Mental Reset', setting: ['court', 'match-day'], equipment: ['none'], tags: ['pressure', 'mental-routine', 'match-day', 'pressure-reset'], identitySlugs: ['relentless-competitor-4-0', 'consistent-builder-4-0'] },
