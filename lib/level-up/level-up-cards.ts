...
const CARD_SEEDS: CardSeed[] = [
  ...
  { title: 'Doubles Return First Move', category: 'doubles-drill', pack: 'Doubles Tools', setting: ['court'], equipment: ['partner'], tags: ['doubles-communication', 'return-intent', 'partner-first-move'] },
