...
const identityMap: Record<string, string[]> = {
  ...
  'crosscourt-build': ['consistent-builder-4-0', 'defensive-counterpuncher-4-0'],
...
const CARD_SEEDS: CardSeed[] = [
  ...
  { title: 'Wall Depth Builder', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'wall-work', 'depth', 'crosscourt-build'], identitySlugs: ['consistent-builder-4-0', 'defensive-counterpuncher-4-0'] },
  { title: 'Wall Recovery Rule', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'recovery'] },
  { title: 'Wall Alternating FH/BH', category: 'solo-drill', pack: 'Wall + Shadow Work', setting: ['wall'], equipment: ['wall'], tags: ['wall', 'wall-work', 'strokes', 'crosscourt-build'], identitySlugs: ['consistent-builder-4-0', 'defensive-counterpuncher-4-0'] },
  ...
  { title: 'Crosscourt Consistency', category: 'partner-drill', pack: 'Partner Drills', setting: ['court'], equipment: ['partner'], tags: ['partner', 'consistency', 'crosscourt-build', 'decision-quality'], identitySlugs: ['consistent-builder-4-0', 'smart-attacker-4-0-to-4-5', 'defensive-counterpuncher-4-0', 'all-court-adapter-4-0'] },
