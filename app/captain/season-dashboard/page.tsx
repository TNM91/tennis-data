      ...
      <div style={contentStyle}>
        ...
        <section style={surfaceStyle} aria-label="Match Week readiness">
          ...
          <div style={readinessGridStyle}>
            ...
            <ReadinessItem label="Team replies" value={hasReplies ? `${cloudReadiness ? cloudReadiness.summary.roster - cloudReadiness.summary.waiting : responseRows.length} tracked` : 'Not sent'} detail={replyRisk ? `${replyRisk} selected-player follow-up${replyRisk === 1 ? '' : 's'}` : hasReplies ? 'Selected players are clear' : 'Send the plan when ready'} ready={hasReplies && replyRisk === 0} />
