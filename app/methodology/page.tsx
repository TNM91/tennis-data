      ...
      >
        ...
        <div>
          ...
          <p>
            ...
            K × (1 − expected), and a loss by K × (0 − expected).
          </p>
          ...
          <ul style={{ paddingLeft: 20, marginTop: 8, display: 'grid', gap: 6 }}>
            <li>Matches 1–9: <strong>2× K</strong> (fast calibration)</li>
            <li>Matches 10–19: <strong>1.5× K</strong></li>
            <li>Matches 20–29: <strong>1.2× K</strong></li>
            <li>Match 30+: <strong>1× K</strong> (stable)</li>
          </ul>
          <p style={{ marginTop: 10 }}>
        ...
        <div>
          ...
          <p>
            ...
            A match played today carries full weight (1.12×); a match played two or more years ago
            carries reduced weight (0.88×), with a linear scale in between. A player&rsquo;s recent
