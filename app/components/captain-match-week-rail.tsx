...
const mobileStepLink: CSSProperties = { flexDirection: 'column', justifyContent: 'center', minWidth: 0, gap: 3, padding: '7px 5px', fontSize: 10, lineHeight: 1.15, textAlign: 'center' }
