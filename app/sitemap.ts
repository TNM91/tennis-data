...
const routes: RouteConfig[] = [
  ...
  { path: '/player-development', changeFrequency: 'monthly', priority: 0.84 },
  { path: '/compete', changeFrequency: 'weekly', priority: 0.84 },
  { path: '/manage', changeFrequency: 'weekly', priority: 0.84 },
