...
for (const flow of flowMaps) {
  ...
  console.log(`- Tester role: ${flow.testerRole}`)
  console.log(`- Fixtures: ${flow.fixtureIds.join(', ')}`)
  console.log(`- Access check: ${flow.accessCheck}`)
  console.log(`- Evidence artifact: ${flow.evidenceArtifact}`)
  console.log(`- Return-state proof: ${flow.returnStateProof}`)
