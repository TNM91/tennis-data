...
2. Run `npm run qa:day1` when testing Day 1 journeys.
3. Run `npm run verify:closeout:live` after production deploys.
4. Record the pass or failure in `docs/platform-closeout-verification-log.md`.
5. Confirm the account/data fixtures needed for that day.
6. Prepare result rows in `docs/customer-journey-test-results.md`.
