...
- For production closeout checks after deploy in PowerShell, run `$env:PLATFORM_QA_BASE_URL='https://www.tenaceiq.com'; $env:LEVEL_UP_BASE_URL='https://www.tenaceiq.com'; npm run verify:closeout`
...
- Production closeout with `PLATFORM_QA_BASE_URL` and `LEVEL_UP_BASE_URL` should pass after deploy
